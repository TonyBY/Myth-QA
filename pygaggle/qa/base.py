...
class Answer: # Predicted answers
    """
    ...
    def __init__(
        ...
        self.refuting_evidence = refuting_evidence

class Ground_True_Answers:
    """
    Class representing an answer.
    An answer contains the answer text itself and potentially other metadata.
    Parameters
    ...
    supporting_evidence : Optional[List[str]]
        The list of passage(tweets) that support the answer.
    refuting_evidence : Optional[List[str]]
        The list of passage(tweets) that refute the answer.
    neutral_evidence : Optional[List[str]]
        The list of passage(tweets) that are relevant but neutral to the answer.
    """
    def __init__(
            self,
            text: str,
            supporting_evidence: Optional[List[str]] = None,
            refuting_evidence: Optional[List[str]] = None,
            neutral_evidence: Optional[List[str]] = None,
    ):
        self.text = text
        self.supporting_evidence = supporting_evidence
        self.refuting_evidence = refuting_evidence
        self.neutral_evidence = neutral_evidence
